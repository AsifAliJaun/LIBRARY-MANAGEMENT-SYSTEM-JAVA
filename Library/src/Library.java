...
public class Library extends JFrame {
	...
	public Library() {
		...
		JLabel lblLibraryManagement = new JLabel("Library Management -by ASIF ALI");
		lblLibraryManagement.setFont(new Font("Tahoma", Font.ROMAN_BASELINE, 18));
		...
		btnAdminLogin.setFont(new Font("Tahoma", Font.ROMAN_BASELINE, 15));
